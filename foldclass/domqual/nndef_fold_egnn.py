...
from egnn_nocoords import EGNN
...
class FoldClassNet(nn.Module):
    def __init__(self,width,nblocks):
        super().__init__()
    ...
    def forward(self, x):
        ...
        out = self.linout(out_feats.mean(dim=1))
